...
class Migration(migrations.Migration):
    dependencies = [
        ('RegisterAccounts', 'previous_migration'),
    ]
    operations = [
...
class UserStudent(AbstractUser):
    groups = models.ManyToManyField(Group, verbose_name="Groups", blank=True, related_name='RegisterAccounts_student_groups')
    user_permissions = models.ManyToManyField(Permission, verbose_name="User Permissions", blank=True, related_name='RegisterAccounts_student_users_permissions')
...
class UserRecruitment_Announcer(AbstractUser):
    groups = models.ManyToManyField(Group, verbose_name="Groups", blank=True, related_name='RegisterAccounts_recruitment_announcer_groups')
    user_permissions = models.ManyToManyField(Permission, verbose_name="User Permissions", blank=True, related_name='RegisterAccounts_recruitment_announcer_user_permissions')
